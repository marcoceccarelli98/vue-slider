...
Partendo dal markup della versione svolta in js plain (quella descritta sotto), rifare lo slider ma questa volta usando Vue.
...
ESERCIZIO DI PARTENZA JS PLAIN
